...
class OrderController {
  constructor () {
    ...
    this.getOrderFromProductName = this.getOrderFromProductName.bind(this)
  }
  ...
  async getOrderFromProductName (req, res) {
    try {
      const orderFromProductName = await this.orderService.getOrderFromProductName(req.query.productName)
      res.json(orderFromProductName)
    } catch (err) {
      res.status(500).send(err.message)
    }
  }
